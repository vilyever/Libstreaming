...
public class H264Stream extends VideoStream {
    ...
    public synchronized void configure() throws IllegalStateException, IOException {
        ...
        Logger.log("testH264 B");
        mConfig = testH264();
        Logger.log("testH264 A");
    }
    ...
    private MP4Config testMediaCodecAPI() throws RuntimeException, IOException {
        ...
        try {
            ...
            Logger.log("debugger B");
            EncoderDebugger debugger = EncoderDebugger.debug(mSettings, mQuality.resX, mQuality.resY);
            Logger.log("debugger A");
...
//        final String TESTFILE = Environment.getExternalStorageDirectory().getPath() + "/spydroid-test.mp4";
        final String TESTFILE = ContextHolder.getContext().getCacheDir().getPath() + "/spydroid-test.mp4";
        ...
        try {
            ...
            // TODO: 2016/5/20 no test to start this on tpad will start fail
            ...
            Logger.logWithAllCaller("RuntimeException " + e.getMessage() + " < " + e.getCause());
            throw new ConfNotSupportedException(e.getMessage());
        }
